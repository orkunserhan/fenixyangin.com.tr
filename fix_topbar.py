...
# I will replace the ENTIRE topbar div cleanly!
topbar = '''<div class="fx-wrap fx-topbar" style="display:flex; justify-content:space-between; align-items:center; background:var(--fx-red); color:#fff; padding:6px 20px;">
  <div style="opacity:0.95; letter-spacing:0.3px; font-size:14px; font-weight:500;">Bizi arayın +90 212 618 07 01 - 02 <span style="margin:0 8px; opacity:0.5;">|</span> info@fenixyangin.com.tr</div>
...
content = re.sub(r'<div class="fx-wrap fx-topbar".*?</div>\s*</div>\s*</div>', topbar, content, flags=re.DOTALL)
